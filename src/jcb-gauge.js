   ...
   render() {
      ...
      return html`
         <svg viewBox="-1050 -1050 2100 1500" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect fill="#F1FEF0" x="-1050" y="-1050" rx="100" ry="100" width="2100" height="1500" />
            ...
            <rect fill="#D2FCD9" x="-1050" y="150" rx="100" ry="100" width="2100" height="300" />

            <text text-anchor="middle" style="white-space: pre; fill: black; text-align: center; font: bold 100px sans-serif;" x="0" y="330">Energie (kcal)</text>
         </svg>
      `
   }
